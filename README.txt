...
Access the plugin settings via the WordPress admin panel.
Customize typographic scales and color settings according to your needs.
Automatic SCSS Compilation
Swell Scales automatically compiles SCSS files and enqueues the resulting style.min.css in your WordPress theme. This ensures that your styles are up-to-date without requiring manual compilation.
...
Support
For any issues or support requests, please visit our support page or contact us at support@example.com.
